export const adminMessages = {
  ...
  pages: {
    ...
    settings: {
      ...
      passwordTitle: { ko: "비밀번호 변경", en: "Change password", ja: "パスワード変更" },
      passwordHint: {
        ko: "변경하면 지금 사용 중인 기기만 남고 다른 기기는 로그아웃됩니다. 임시 비밀번호를 받으셨다면 여기서 바꿔 주세요.",
        en: "Changing it signs you out on other devices; this one stays signed in. If you received a temporary password, change it here.",
        ja: "変更すると、このデバイス以外はログアウトされます。仮パスワードを受け取った場合はここで変更してください。",
      },
      currentPassword: { ko: "현재 비밀번호", en: "Current password", ja: "現在のパスワード" },
      newPassword: { ko: "새 비밀번호", en: "New password", ja: "新しいパスワード" },
      confirmPassword: { ko: "새 비밀번호 확인", en: "Confirm new password", ja: "新しいパスワード（確認）" },
      submit: { ko: "변경", en: "Change", ja: "変更" },
      changed: { ko: "비밀번호를 변경했습니다.", en: "Password changed.", ja: "パスワードを変更しました。" },
      changeFailed: {
        ko: "비밀번호를 변경하지 못했습니다.",
    ...
    team: {
      ...
      password: {
        changeTitle: { ko: "비밀번호 변경", en: "Change password", ja: "パスワード変更" },
        current: { ko: "현재 비밀번호", en: "Current password", ja: "現在のパスワード" },
        new: { ko: "새 비밀번호", en: "New password", ja: "新しいパスワード" },
        confirm: { ko: "새 비밀번호 확인", en: "Confirm new password", ja: "新しいパスワード（確認）" },
        submit: { ko: "변경", en: "Change", ja: "変更" },
        saving: { ko: "처리 중…", en: "Saving…", ja: "処理中…" },
        changeHint: {
          ko: "비밀번호는 8자 이상이어야 합니다. 변경하면 다른 기기의 로그인은 모두 해제됩니다.",
          en: "Use at least 8 characters. Changing it signs you out on all other devices.",
          ja: "パスワードは8文字以上。変更すると他の端末のログインはすべて解除されます。",
        },
        changed: {
          ko: "비밀번호를 변경했습니다.",
          en: "Password changed.",
        ...
        invalidInput: {
          ko: "비밀번호를 8자 이상 입력해 주세요.",
          en: "Enter a password of at least 8 characters.",
          ja: "パスワードは8文字以上で入力してください。",
        },
        mismatch: {
          ko: "새 비밀번호가 서로 일치하지 않습니다.",
          en: "The new passwords do not match.",
          ja: "新しいパスワードが一致しません。",
        },
        reset: { ko: "비밀번호 재설정", en: "Reset password", ja: "パスワード再設定" },
        resetTitle: {
          ko: "{member} 비밀번호 재설정",
          en: "Reset password for {member}",
          ja: "{member} のパスワード再設定",
        },
        ...
        resetHint: {
          ...
          en: "At least 8 characters. Share it through a secure channel and ask the member to change it after signing in. Resetting signs the account out everywhere.",
          ja: "8文字以上。安全な方法で本人に伝え、ログイン後に本人で変更するよう案内してください。再設定するとそのアカウントの全セッションが解除されます。",
        },
        resetDone: {
          ko: "임시 비밀번호를 발급했습니다: {password}",
          en: "Temporary password issued: {password}",
          ja: "仮パスワードを発行しました：{password}",
        },
        resetFailed: {
          ko: "비밀번호 재설정에 실패했습니다",
