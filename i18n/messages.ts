  ...
  pages: {
    ...
    applications: {
      ...
      detail: {
        ...
        msgReviewing: { jp: "確認中です。", kr: "브랜드가 검수 중입니다." },
        msgCompleted: {
          jp: "完了しました。報酬のお振込まで今しばらくお待ちください。\n報酬振込時期：インサイトご提出月の翌月末",
          kr: "완료되었습니다. 입금 예정을 기다려 주세요.",
        },
        thanksTitle: {
          jp: "キャンペーンにご参加いただきありがとうございました。",
        ...
        rejectPrefix: { jp: "未選定となりました。ご希望に添えず申し訳ございません。また次のキャンペーンでお待ちしております！", kr: "미선정되었습니다. 기대에 부응하지 못해. 죄송합니다. 다음 캠페인에서 또 기다리고 있겠습니다!" }, // new
        cancelledNotice: {
